...
%%%
-module(snmp_simulator_server).
-copyright('Copyright (c) 2018-2020 SigScale Global Inc.').

-behaviour(gen_server).

%% export the snmp_simulator_server API
-export([]).
...
%%----------------------------------------------------------------------
%%  The snmp_simulator_server API
%%----------------------------------------------------------------------

%%----------------------------------------------------------------------
%%  The snmp_simulator_server gen_server callbacks
%%----------------------------------------------------------------------
